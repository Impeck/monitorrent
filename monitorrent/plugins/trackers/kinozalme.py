...
class KinozalTracker(object):
    ...
    login_url = "http://kinozal.me/takelogin.php"
    profile_page = "http://kinozal.me/inbox.php"
    url_regex = re.compile(six.text_type(r'^https?://kinozal\.me/details\.php\?id=(\d+)$'))
    ...
    def get_download_url(self, url):
        ...
        return "http://dl.kinozal.me/download.php?id=" + torrent_id
